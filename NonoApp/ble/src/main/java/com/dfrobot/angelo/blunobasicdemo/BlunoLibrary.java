...
public abstract class BlunoLibrary extends ComponentActivity {
    ...
    {
        requestEnableBluetoothLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
    ...
    public void onResumeProcess() {
	    ...
	    if (Build.VERSION.SDK_INT >= 33) {
			mainContext.registerReceiver(mGattUpdateReceiver, makeGattUpdateIntentFilter(), Context.RECEIVER_NOT_EXPORTED);
		} else {
...
//            mHandler.postDelayed(mDisonnectingOverTimeRunnable, 10000);
	...
	private class LeDeviceListAdapter extends BaseAdapter {
		...
		public LeDeviceListAdapter() {
			...
			mInflator = LayoutInflater.from(mainContext);
		}
